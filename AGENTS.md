...
- `omafetch about` renders the default fetch, then waits for one key when stdin is a TTY. Menu wiring is the user extension `~/.config/omarchy/extensions/omarchy-menu.jsonc`, not a packaged Omarchy binary.
